...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusCheck.from_range'
        db.add_column(u'cabotapp_statuscheck', 'from_range',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusCheck.from_range'
        db.delete_column(u'cabotapp_statuscheck', 'from_range')
    ...
    models = {
        ...
        u'cabotapp.statuscheck': {
            ...
            'from_range': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
